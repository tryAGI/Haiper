...
The Haiper SDK provides integration with [Microsoft.Extensions.AI](https://learn.microsoft.com/en-us/dotnet/ai/microsoft-extensions-ai), enabling seamless interoperability with the unified .NET AI abstractions.

## Installation

```bash
dotnet add package Haiper
```
...
using var client = new HaiperClient(
    apiKey: Environment.GetEnvironmentVariable("HAIPER_API_KEY")!);
