...
internal static partial class CreateImageToVideoCommandApiCommand
{
    ...
    private static Option<global::Haiper.ImageToVideoRequestGenMode?> GenMode { get; } = new(
        name: @"--gen-mode")
    {
        Description = @"",
    };

    private static Option<global::Haiper.ImageToVideoConfig> Config { get; } = new(
        name: @"--config")
    {
        Description = @"",
        Required = true,
    ...
    public static Command Create()
    {
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            ...
            {
                        var __requestBase = await CliRuntime.ReadRequestOrDefaultAsync<global::Haiper.ImageToVideoRequest>(
                            parseResult,
                            Input,
                            RequestJson,
                            RequestFile,
