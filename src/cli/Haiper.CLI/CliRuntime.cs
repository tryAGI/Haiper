...
namespace Haiper.CLI;

internal static class CliRuntime
{
    private const string UserSecretsId = "Haiper.CLI";
    private const string UserSecretApiKeyName = "HAIPER_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"HAIPER_API_KEY"];
    private const string CredentialFileDirectoryName = ".haiper";

    public static async global::System.Threading.Tasks.Task<global::Haiper.HaiperClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::Haiper.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::Haiper.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "Http",
        ...
        return new global::Haiper.HaiperClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::Haiper.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::Haiper.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::Haiper.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::Haiper.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("HAIPER_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::Haiper.ApiException exception)
    {
        var builder = new StringBuilder();
