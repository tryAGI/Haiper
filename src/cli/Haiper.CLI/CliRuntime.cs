...
internal static class CliRuntime
{
    ...
    public static async Task<global::Haiper.HaiperClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
    ...
    private static async Task WriteApiExceptionAsync(global::Haiper.ApiException exception)
    {
        var builder = new StringBuilder();
