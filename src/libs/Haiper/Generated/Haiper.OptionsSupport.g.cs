...
namespace Haiper
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Haiper.AutoSDKRetryOptions Retry { get; set; } = new global::Haiper.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Haiper.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Haiper.IAutoSDKHook>();
        ...
        public global::Haiper.AutoSDKClientOptions AddHook(
            global::Haiper.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Haiper.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Haiper.AutoSDKClientOptions UseAuthorizationProvider(
            global::Haiper.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Haiper.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Haiper.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Haiper.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Haiper.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Haiper.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Haiper.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Haiper.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Haiper.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Haiper.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Haiper.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Haiper.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Haiper.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Haiper.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Haiper.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Haiper.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Haiper.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Haiper.AutoSDKClientOptions clientOptions,
            global::Haiper.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Haiper.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Haiper.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Haiper.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Haiper.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Haiper.IAutoSDKHook, global::Haiper.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Haiper.AutoSDKHookContext context)
        {
